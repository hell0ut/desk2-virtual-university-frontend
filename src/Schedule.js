                ...
                <div className="row mt-3">
                    <div className="col ms-1 me-1 ">
                        <div className="row schedule rounded-top justify-content-between p-1">
                            ...
                            <div className="col-5">01.02.21</div>
                        </div>
                        ...
                        <div className="row border-bottom border-3 mt-1 mb-1">
                            <div className="col-3">10:25-12:00</div>
                        ...
                        <div className="row border-bottom border-3 mt-1 mb-1 current">
                            <div className="col-3">12:20-13:55</div>
                            <div className="col-7 ms-3 me-0 "><span className="dot ms-1 me-1"
                    ...
                    <div className="col ms-1 me-1 ">
                        <div className="row exams rounded-top justify-content-between p-1">
                            ...
                            <div className="col-5">02.02.21</div>
                        </div>
                        <div className="row border-bottom border-3 mt-1 mb-1">
                            <div className="col-3">8:30-10:05</div>
                            <div className="col-7  ms-3 me-0"><span className="dot ms-1 me-1"></span>Linear Algebra
                    ...
                    <div className="col ms-1 me-1 ">
                        <div className="row deadlines rounded-top justify-content-between p-1">
                            ...
                            <div className="col-5">03.02.21</div>
                        </div>
                        <div className="row border-bottom border-3 mt-1 mb-1">
                            <div className="col-3">8:30-10:05</div>
                        ...
                        <div className="row border-bottom border-3 mt-1 mb-1">
                            <div className="col-3">13:55-15:50</div>
                            <div className="col-7 ms-3 me-0"><span className="dot ms-1 me-1"
